...
@import Foundation;
@class ExternalAPI;
@class CometChatEventEmitter;
 
@interface CometChatCallsInternal : NSObject
...
- (ExternalAPI *_Nonnull)getExternalAPI;

- (CometChatEventEmitter *_Nonnull)getCometChatEventEmitter;

- (void)emitEvent:(NSString *)event :(NSDictionary *)data;
